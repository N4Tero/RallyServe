        ...
        <div style="background: white; border-radius: 16px; border: 1px solid #e5e7eb; overflow: hidden; transition: 0.3s ease;">
          ...
          <div style="padding: 1.5rem;">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.5rem;">
               <h3 style="font-size: 1.25rem; font-weight: 800; margin: 0;">Gensan Smash Arena</h3>
               <span style="font-size: 0.8rem; color: #14a84d; font-weight: 700;">★ 4.8</span>
            </div>
            <p style="color: #6b7280; font-size: 0.9rem; margin-bottom: 1.5rem;">📍 City Heights, General Santos</p>
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; border-top: 1px solid #f3f4f6; padding-top: 1rem;">
                ...
                <a href="/bookings/create?court=Gensan+Smash+Arena" class="btn btn-primary" style="padding: 0.5rem 1.25rem; border-radius: 50px; text-decoration: none; font-size: 0.85rem;">Book Now</a>
            </div>
          </div>
        </div>
